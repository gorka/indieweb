...
class MicropubRocks6Test < ActionDispatch::IntegrationTest
  ...
  test "603: Source Query (Specific Properties)" do
    ...
    get micropub_url(subdomain: blog.subdomain, q: "source", properties: ["content", "category"], url: entry_url(Entry.last))
  ...
  test "603: Source Query (Specific Properties) (extra)" do
    ...
    get micropub_url(subdomain: blog.subdomain, q: "source", properties: ["content"], url: entry_url(Entry.last))
